    ...
    >
      ...
      >
        ...
        <div className="flex justify-end -mt-4">
          <button
            onClick={() => setDarkMode(!darkMode)} // Toggle dark mode state on click
            className={`p-2 rounded-full transition-colors duration-200 
              ${darkMode ? "bg-slate-700 text-blue-300 hover:bg-slate-600" : "bg-blue-50 text-blue-600 hover:bg-blue-100"}`}
            aria-label="Toggle dark mode"
          >
            {/* Conditional rendering of Sun/Moon icon based on dark mode state */}
            {darkMode ? (
        ...
        <div className="space-y-3">
          ...
          >
            {/* KaTeX output is dynamically inserted here by the useEffect hook */}
          </div>
        </div>
